...
const faqData = [
  ...
  {
    question: "Asa man ko nagkuwang?",
    answer: "Ikaw man ang problema"
  }
];
...
export default function ChatBot() {
  ...
  const findAnswer = (question: string): string => {
    ...
    if (normalizedQuestion.includes('developer') || normalizedQuestion.includes('who made') || normalizedQuestion.includes('created by') || normalizedQuestion.includes('who developed')) {
      return faqData[9].answer;
    }
    if (normalizedQuestion.includes('asa man ko nagkuwang') || normalizedQuestion.includes('nagkuwang')) {
      return faqData[10].answer;
    }
  ...
  return (
    <Card className="w-full max-w-4xl mx-auto h-[60vh] sm:h-[70vh] bg-card/80 backdrop-blur-sm glow-border flex flex-col chat-container">
      {/* Header */}
      ...
      {/* Messages */}
      <div className="flex-1 p-4 sm:p-6 overflow-y-auto space-y-4 min-h-0 messages-area">
      ...
      {/* Quick Responses */}
      <div className="px-4 sm:px-6 py-3 border-t border-border/30 flex-shrink-0">
      ...
      {/* Input */}
      <div className="p-4 sm:p-6 border-t border-border/50 flex-shrink-0">
